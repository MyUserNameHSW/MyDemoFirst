...
import com.lyy.dao.IList1Selete;
import com.lyy.util.DBUtils;
import com.lyy.util.PageNums;

public class ListPage implements IList1Selete{
    public int count = 0;
	@Override
	public List<Product> list1Selete(int S_id, String item,int pageNum) {
		List<Product> list = new ArrayList<>();
		Connection connection = DBUtils.getConnection();
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		String sql = "select * from product where S_id=? and type=? limit ?,?";
